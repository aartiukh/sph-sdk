...
{
    const Point3FVector mesh = SPHAlgorithms::MarchingCubes::generateMesh(pawnEquation);
...
{
    const Point3FVector mesh = SPHAlgorithms::MarchingCubes::generateMesh(bishopEquation);
